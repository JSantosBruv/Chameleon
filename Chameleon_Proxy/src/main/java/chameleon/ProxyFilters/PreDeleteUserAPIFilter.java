...
@Component
public class PreDeleteUserAPIFilter extends AbstractGatewayFilterFactory<PreDeleteUserAPIFilter.Config> {

    final UserController userHandler;
    final FiltersChangeUtils filtersChangeUtils;

    public PreDeleteUserAPIFilter(FiltersChangeUtils bodyChangeUtils, UserController userHandler) {
        super(Config.class);
