...
@Component
public class PostSearchAPIFilter extends AbstractGatewayFilterFactory<PostSearchAPIFilter.Config> {

    final SearchController queryHandler;
    final FiltersChangeUtils filtersChangeUtils;

    public PostSearchAPIFilter(FiltersChangeUtils bodyChangeUtils, SearchController queryHandler) {
        super(Config.class);
    ...
    private RewriteFunction<String, String> decryptSearchResults() {
        ...
        return (exchange, originalResponseBody) -> {
            ...
            String decryptedResults = queryHandler.decryptSearchResults(index, originalResponseBody, authHeader);
